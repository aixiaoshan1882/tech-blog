      ...
      <div className="w-full max-w-sm sm:max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">记住我</span>
              </label>
              <Link to="/forgot-password" className="text-xs sm:text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400">
                忘记密码？
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:-translate-y-0.5 text-sm sm:text-base"
            >
              {loading ? (
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
            <p className="text-xs text-gray-500 dark:text-gray-400 text-center mb-1.5 sm:mb-2">测试账号</p>
